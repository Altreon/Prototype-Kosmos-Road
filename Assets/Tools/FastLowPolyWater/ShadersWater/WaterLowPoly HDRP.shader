    ...
    SubShader
    {
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert ( AttributesMesh inputMesh  )
			{
				...
				float4 temp_output_69_0 = ( float4( inputMesh.positionOS.xyz , 0.0 ) + appendResult51 );
						...
						)
			{
				...
				float screenDepth13 = LinearEyeDepth( SampleCameraDepth( screenPos13.xy/screenPos13.w ).r,_ZBufferParams);
				float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm13.z,_ZBufferParams ) ) / ( _SizeFoam ) );
				float lerpResult17 = lerp( distanceDepth13 , ( distanceDepth13 * ( 1.0 - normalWS.y ) ) , 0.998);
				...
				float screenDepth28 = LinearEyeDepth( SampleCameraDepth( screenPos28.xy/screenPos28.w ).r,_ZBufferParams);
        ...
        Pass
        {
			...
			PackedVaryingsMeshToPS Vert ( AttributesMesh inputMesh  )
			{
				...
				float4 ase_clipPos28 = TransformWorldToHClip( TransformObjectToWorld(vertexPos28));
				float4 screenPos28 = ComputeScreenPos( ase_clipPos28 , _ProjectionParams.x );
				outputPackedVaryingsMeshToPS.ase_texcoord2 = screenPos28;
			...
			float4 Frag ( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 screenPos28 = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm28 = screenPos28 / screenPos28.w;
				ase_screenPosNorm28.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm28.z : ase_screenPosNorm28.z * 0.5 + 0.5;
				float screenDepth28 = LinearEyeDepth( SampleCameraDepth( screenPos28.xy/screenPos28.w ).r,_ZBufferParams);
				float distanceDepth28 = abs( ( screenDepth28 - LinearEyeDepth( ase_screenPosNorm28.z,_ZBufferParams ) ) / ( _Depth ) );
        ...
        Pass
        {
            ...
            HLSLPROGRAM
										...
										)
				{
					...
					float4 ase_clipPos13 = TransformWorldToHClip( TransformObjectToWorld(vertexPos13));
					float4 screenPos13 = ComputeScreenPos( ase_clipPos13 , _ProjectionParams.x );
					outputPackedVaryingsToPS.ase_texcoord3 = screenPos13;
					float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
					outputPackedVaryingsToPS.ase_texcoord4.xyz = ase_worldNormal;
					float3 vertexPos28 = temp_output_69_0.xyz;
					float4 ase_clipPos28 = TransformWorldToHClip( TransformObjectToWorld(vertexPos28));
					float4 screenPos28 = ComputeScreenPos( ase_clipPos28 , _ProjectionParams.x );
					outputPackedVaryingsToPS.ase_texcoord5 = screenPos28;
						...
						)
				{
					...
					AlphaSurfaceDescription surfaceDescription = (AlphaSurfaceDescription)0;
                    float4 screenPos13 = packedInput.ase_texcoord3;
                    float4 ase_screenPosNorm13 = screenPos13 / screenPos13.w;
                    ase_screenPosNorm13.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm13.z : ase_screenPosNorm13.z * 0.5 + 0.5;
                    float screenDepth13 = LinearEyeDepth( SampleCameraDepth( screenPos13.xy/screenPos13.w ).r,_ZBufferParams);
                    float distanceDepth13 = abs( ( screenDepth13 - LinearEyeDepth( ase_screenPosNorm13.z,_ZBufferParams ) ) / ( _SizeFoam ) );
...
/*ASEBEGIN
Version=16300
7;1;1352;698;-1694.208;-419.7693;1.675909;True;False
...
Node;AmplifyShaderEditor.PosVertexDataNode;70;2993.294,1184.135;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;69;3409.294,1292.135;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-1452.036,952.2343;Float;False;Property;_Depth;Depth;3;0;Create;True;0;0;False;0;0;1.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;11;-653.0463,617.0334;Float;False;Property;_Colorwater;Color water;0;0;Create;True;0;0;False;0;0,0,0,0;0.1058824,0.4798574,0.5607843,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;31;-575.4737,369.9068;Float;False;Property;_ColorDepth;Color Depth;1;0;Create;True;0;0;False;0;0,0,0,0;0.05965098,0.1096801,0.1607843,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;62;7;39;0
WireConnection;62;9;51;0
ASEEND*/
//CHKSM=2AC98EEE43A86428A23AC7855F47884FBC39B537